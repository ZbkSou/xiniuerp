...
<!--      </el-form-item>-->
      ...
      <el-form-item label="渠道单号" prop="channelSn">
        <el-input
          v-model="queryParams.channelSn"
          placeholder="请输入渠道单号"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否拆分发货0否1是" prop="splitShipment">
          <el-input v-model="form.splitShipment" placeholder="请输入是否拆分发货0否1是" />
        </el-form-item>
        <el-form-item label="渠道单号" prop="channelSn">
          <el-input v-model="form.channelSn" placeholder="请输入渠道单号" />
        </el-form-item>
        <el-form-item label="渠道名" prop="channelName">
          <el-input v-model="form.channelName" placeholder="请输入渠道名" />
        </el-form-item>
        <el-form-item label="订单所在部门id" prop="deptId">
          <el-input v-model="form.deptId" placeholder="请输入订单所在部门id" />
        </el-form-item>
        <el-form-item label="发货时间" prop="shippingTime">
          <el-date-picker clearable size="small"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        paymentMethod: [
          { required: true, message: "支付方式：1现金，2余额，3网银，4支付宝，5微信不能为空", trigger: "blur" }
        ],
        orderMoney: [
        ...
        splitShipment: [
          { required: true, message: "是否拆分发货0否1是不能为空", trigger: "blur" }
        ],
        createTime: [
